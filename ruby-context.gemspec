...
Gem::Specification.new do |spec|
  ...
  spec.version       = '0.1.0'
  spec.authors       = %w[Kekzuke Zurak asthmatick1dd0]
  spec.email         = ['asthmatick1dd0@gmail.com']

  spec.summary       = 'Go-like context library for Ruby'
  spec.description   = 'A Ruby implementation of Go-like contexts for managing ' \
                       'cancellation, deadlines, and values across goroutine-like abstractions'
