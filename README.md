...
> [!NOTE]
> Проект находится в активной разработке. API небольшой и будет расширяться итеративно.
...
| Deadline API | In progress | Базовая логика есть, публичный API будет расширяться |
